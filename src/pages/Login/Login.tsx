...
const Login: React.FC = (props) => {
  return (
    <div className="container">
      ...
      <div className='col' ><img src="https://d3lpnmaex2fqln.cloudfront.net/uploads/banner-2-1655441565.jpg" alt="" /></div>
      <div className="col">
      <form className={styles["form_container"]}>
        ...
        <div className={styles.input_container}>
          ...
          <input placeholder="name@mail.com" title="Inpit title" name="input-name" type="text" className={styles.input_field} id="email_field" />
        </div>
        <div className={styles.input_container}>
          ...
          <input placeholder="Password" title="Inpit title" name="input-name" type="password" className={styles.input_field} id="password_field" />
        </div>
        ...
        <button title="Sign In" type="submit" className={styles["sign-in_apl"]}>
